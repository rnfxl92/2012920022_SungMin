...
class MediaPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        this.add(createBox("mediaDesc"));
        this.add(createBox("mediaType"));
        this.add(createBox("url"));
        this.add(createBox("alternateUrl"));
        this.add(createBox("contentType"));
        this.add(createBox("conTentLength"));
        this.add(createBox("mediaAssoc"));
